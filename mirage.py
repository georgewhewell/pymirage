...
so_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "libmirageaudio.so")

cdll.LoadLibrary(so_path)
...
mirageaudio_initgst = libmirageaudio.mirageaudio_initgst
...
class AudioDecoder(object):
    def __init__(self, rate, seconds, winsize):
        ...
        mirageaudio_initgst(self.ma, None)
